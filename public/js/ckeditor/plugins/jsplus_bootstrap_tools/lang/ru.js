CKEDITOR.plugins.setLang('jsplus_bootstrap_show_blocks', 'ru',  {    bootstrap_show_blocks: 'Показать Bootstrap блоки',    foundation_show_blocks: 'Показать Foundation блоки'} );CKEDITOR.plugins.setLang('jsplus_bootstrap_block_conf', 'ru',  {    title: 'Редактирование блока',    none: 'Нет',    width: 'Ширина',    offset: 'Сдвиг',    visibility: 'Видимость',    size: 'Размер дисплея',    size_lg: 'Большой',    size_md: 'Средний',    size_sm: 'Малый',    size_xs: 'Сверхмалый',    size_print: 'Печать',    show_by_size: 'Видимость по ширине',    show_by_orientation: 'Видимость по ориентации',    btn_ok: "OK",    btn_cancel: "Отмена"} );﻿CKEDITOR.plugins.setLang('jsplus_bootstrap_templates', 'ru', {
    ...
    btn_ok: "OK",
    btn_cancel: "Отмена"
} );﻿CKEDITOR.plugins.setLang('jsplus_bootstrap_row_add_up', 'ru', {
    ...
    btn_ok: "OK",
    btn_cancel: "Отмена"
} );﻿CKEDITOR.plugins.setLang('jsplus_bootstrap_row_add_down', 'ru', {
    ...
    btn_ok: "OK",
    btn_cancel: "Отмена"
} );CKEDITOR.plugins.setLang('jsplus_bootstrap_button', 'ru',  {
...
CKEDITOR.plugins.setLang('jsplus_bootstrap_gallery', 'ru', {
        ...
        select_files_first: 'Укажите файлы',

        btn_ok: "OK",
        btn_cancel: "Отмена"
	}
);CKEDITOR.plugins.setLang('jsplus_bootstrap_badge', 'ru',  {    title: 'Вставить бэдж',    option_title: 'Заголовок',    preview: 'Предпросмотр',    btn_ok: "OK",    btn_cancel: "Отмена"} );CKEDITOR.plugins.setLang('jsplus_bootstrap_label', 'ru',	{		jsplus_bootstrap_label_title: 'Вставить метку Bootstrap',        jsplus_foundation_label_title: 'Вставить метку Foundation',        edit_label: 'Редактировать метку',        option_title: 'Текст',        option_corners: 'Углы',        preview: 'Предпросмотр',        value_style_default: 'По умолчанию', // B only        value_style_primary: 'Основная', // B only        value_style_info: 'Инфо', // B only        value_style_success: 'Успех',        value_style_warning: 'Предупр.',        value_style_danger: 'Опасность', // B only        value_style_secondary: 'Вторичная', // F only        value_style_alert: 'Тревога', // F only        value_corners_none: 'Нет',        value_corners_radius: 'Радиус',        value_corners_rounded: 'Круглые',        btn_ok: "OK",        btn_cancel: "Отмена"});﻿CKEDITOR.plugins.setLang('jsplus_bootstrap_alert', 'ru', {
    ...
    btn_ok: "OK",
    btn_cancel: "Отмена"
} );CKEDITOR.plugins.setLang('jsplus_bootstrap_col_move_left', 'en',  {    row_move_up: 'Переместить строку выше',    row_move_down: 'Переместить строку ниже',    col_move_left: 'Переместить колонку левее',    col_move_right: 'Переместить колонку правее'} );CKEDITOR.plugins.setLang('jsplus_bootstrap_col_move_right', 'en',  {    row_move_up: 'Переместить строку выше',    row_move_down: 'Переместить строку ниже',    col_move_left: 'Переместить колонку левее',    col_move_right: 'Переместить колонку правее'} );CKEDITOR.plugins.setLang('jsplus_bootstrap_row_move_up', 'en',  {    row_move_up: 'Переместить строку выше',    row_move_down: 'Переместить строку ниже',    col_move_left: 'Переместить колонку левее',    col_move_right: 'Переместить колонку правее'} );CKEDITOR.plugins.setLang('jsplus_bootstrap_row_move_down', 'en',  {    row_move_up: 'Переместить строку выше',    row_move_down: 'Переместить строку ниже',    col_move_left: 'Переместить колонку левее',    col_move_right: 'Переместить колонку правее'} );CKEDITOR.plugins.setLang('jsplus_bootstrap_delete_col', 'en',  {    delete_row: 'Удалить строку',    delete_col: 'Удалить колонку',} );CKEDITOR.plugins.setLang('jsplus_bootstrap_delete_row', 'en',  {    delete_row: 'Удалить строку',    delete_col: 'Удалить колонку',} );