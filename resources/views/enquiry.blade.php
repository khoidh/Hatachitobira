            ...
            <form class="form-horizontal">
                    ...
                    <div class="col-sm-9" >
                        <div class="row">
                            <div class="col-sm-6" style="padding-bottom: 15px;">
                                <select name="category_id" class="form-control" required="true" autofocus>
                ...
                <div class="form-group form-group-lg row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-6" style="padding-bottom: 15px">
                                <input id="name" type="text" class="form-control" name="first_name" value=""  placeholder="姓" required tabindex=1>
                            </div>
                            <div class="col-sm-6">
                                <input id="name" type="text" class="form-control" name="last_name" value=""  placeholder="名" required tabindex=1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group form-group-lg row">
                    ...
                    <div class="col-sm-9 ">
                        <div class="row">
                            <div class="col-sm-6" style="padding-bottom: 15px">
                                <input id="name" type="text" class="form-control" name="first_name" value=""  placeholder="せい" required tabindex=1>
                            </div>
                            <div class="col-sm-6">
                                <input id="name" type="text" class="form-control" name="last_name" value=""  placeholder="めい" required tabindex=2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group form-group-lg row">
                    ...
                    <div class="col-sm-9">
                        <input id="name" type="text" class="form-control" name="first_name" value=""  required tabindex=3>
                    </div>
                </div>
                {{-- ==================== メールアドレス ======================= --}}
                <div class="form-group form-group-lg row">
                    ...
                    <div class="col-sm-9">
                        <input id="name" type="text" class="form-control" name="first_name" value=""  required tabindex=4>
                    </div>
                </div>
                {{-- ==================== 郵便番号 ======================= --}}
                <div class="form-group form-group-lg row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-6">
                                <input id="name" type="text" class="form-control" name="first_name" value="" required tabindex=5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group enquiry-btn col-sm-12 ">
