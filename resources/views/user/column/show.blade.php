        ...
        <div id="bread_crumb">
            <ul class="clearfix">
                <li itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb" class="home"><a
                            itemprop="url" href="{{ url('/') }}"><span>ホーム</span></a></li>

                <li><a href="{{route('column.index')}}">コラム一覧</a></li>
        ...
        <div id="main_col" class="clearfix">
            <div id="left_col">
                <div id="article">
                                ...
                                <div class="wrapper">
                                    <div class="content">
                                        <div class="title" style="color: #216A94;"><h4
                                                    style="line-height: 200%">{{$column->title}}</h4></div>
                                        <div class="category"><p>{{$column->category_name}}</p></div>
                                        <div class="row">
                                            <div class="date" ><p>{{date('Y-m-d', strtotime($column->created_at))}}</p></div>
                                            <div class="icon" >
                                                {{--==================== favorite ====================--}}
                                                @if(Auth::user())
                                                    {{ csrf_field() }}
                    ...
                    <p>
                        <button type="button" class="btn btn-primary center-block pl-2 pl-2">マイテーマを見つける</button>
                    </p>
                    ...
                    <ol class="clearfix">
                        @foreach($columns_random as $column)
                            <li class="clearfix num1">
                                ...
                                <div class="desc">
                                    <h4 class="title"><a href="{{route('column.show', $column->id)}}"
                                                         name="">{{str_limit($column->title,$limit=50,$end='...')}}</a>
                                    </h4>
                                </div>
            ...
            <div id="side_col">
                ...
                <div class="side_widget clearfix widget_recent_entries" id="recent-posts-2">
                    ...
                    <ul>
                        @foreach($columns_latest as $column)
                            <li>
                                <a href="{{route('column.show', $column->id)}}">{{$column->title}}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
