...
<div class="event-information-wrapper col-md-12 clearfix">
    <textarea style="width: 100%;border: none;" type="text" rows="3" id="model-textarea-edit" class="input-action" data-month="{{isset($mytheme_first->month) ? $mytheme_first->month : $data['month']}}" data-value="{{$data['field']}}"
