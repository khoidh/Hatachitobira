                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="why-born-col">
                            ...
                            <p class="text_detail jladev_fix_title">約65%が後悔する現実<br><br></p>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="why-born-col">
                            ...
                            <p class="text_detail jladev_fix_title">大学と社会の距離が遠く、将来の選択肢がみえない </p>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="why-born-col">
                            ...
                            <p class="text_detail jladev_fix_title">日本の就活に合わない欧米型のキャリア論</p>
