        ...
        <dif class="form-group row">
            ...
            <div class="col-sm-10 row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <input type="date" class="form-control" name="time_from" value="<?php echo date('Y-m-d\TH:i', strtotime($event->time_from));?>" required="true">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <input type="date" class="form-control" name="time_to" value="<?php echo date('Y-m-d\TH:i', strtotime($event->time_to));?>" required="true">
                    </div>
                </div>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10 row">
                ...
                <div class="col-sm-6" >
                    ...
                    <div class="col-sm-12">
                        <input type="date" class="form-control" name="started_at" value="<?php echo date('Y-m-d\TH:i', strtotime($event->started_at));?>" required="true">
                    </div>
                </div>
                {{--End At--}}
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <input type="date" class="form-control" name="closed_at" value="<?php echo date('Y-m-d\TH:i', strtotime($event->closed_at));?>" required="true">
                    </div>
                </div>
            </div>
        </div>
