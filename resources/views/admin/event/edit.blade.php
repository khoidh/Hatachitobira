...
<form  action="{{route('events.update',$event->id)}}" enctype="multipart/form-data" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea type="text" class="form-control" name="address" id="address" placeholder="{{__('場所')}}" rows="4">{{$event->address}}</textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea type="text" class="form-control" name="overview" id="overview" placeholder="{{__('概要')}}" rows="4">{{$event->overview}}</textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select class="form-control" name="display" id="display">
                <option value="1" <?php if($event->display == 1) echo 'selected' ?> >表示</option>
                <option value="0"<?php if($event->display == 0) echo 'selected' ?> >非表示</option>
            </select>
        </div>
    </div>
